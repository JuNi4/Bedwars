data modify storage bedwars_extras:animatronic poses set value [\
    {Body:[8f,9f,0f],Head:[18f,15f,13f],LeftLeg:[8f,7f,0f],RightLeg:[347f,0f,0f],LeftArm:[349f,0f,0f], RightArm:[0f,0f,0f]},\
    {Body:[353f,360f,0f],Head:[18f,335f,13f],LeftLeg:[347f,310f,0f],RightLeg:[10f,290f,0f],LeftArm:[2f,48f,352f],RightArm:[357f,212f,354f]},\
    {Body:[5.0f,0.0f,0.0f],Head:[10.0f,-10.0f,-3.0f],LeftArm:[-16.0f,-40.0f,0.0f],LeftLeg:[3.0f,-10.0f,-8.0f],RightArm:[-30.0f,7.0f,-15.0f],RightLeg:[-9.0f,4.0f,2.0f]},\
    {Body:[7.0f,3.0f,0.0f],Head:[-5.0f,6.0f,10.0f],LeftArm:[-38.0f,44.0f,-7.0f],LeftLeg:[4.0f,-5.0f,-6.0f],RightArm:[-22.0f,-11.0f,-35.0f],RightLeg:[0.0f,-3.0f,1.0f]},\
