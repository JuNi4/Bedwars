...
execute as @e[tag=clear] at @s run fill ~ -64 ~ ~ 120 ~ air
execute as @e[tag=clear] at @s run fill ~ 142 ~ ~ 319 ~ air
...
# stop this file from being executed
execute unless entity @e[tag=clear] run scoreboard players set run_clear data 0
execute unless entity @e[tag=clear] run kill @e[tag=clear_from_tick]