execute as @e[type=minecraft:spectral_arrow, nbt={inGround:0b}, tag=!put_shot] at @s run function bedwars:rotating_items/popup_tower_arrow/initialize_shot_arrow
...
execute if score arrow_v data matches 5 run return run function bedwars:rotating_items/popup_tower_arrow/place {fx: 90, fy: -90}
execute if score arrow_v data matches 94 run return run function bedwars:rotating_items/popup_tower_arrow/place {fx: -90, fy: -90}
...
execute if score arrow_v data matches 5 run return run function bedwars:rotating_items/popup_tower_arrow/place {fx: -180, fy: -90}
execute if score arrow_v data matches 94 run return run function bedwars:rotating_items/popup_tower_arrow/place {fx: 0, fy: -90}
...
execute if score arrow_v data matches 5 run return run function bedwars:rotating_items/popup_tower_arrow/place {fx: 0, fy: 0}
#execute if score arrow_v data matches 94 run return run function bedwars:rotating_items/popup_tower_arrow/place {fx: 0, fy: -180}
