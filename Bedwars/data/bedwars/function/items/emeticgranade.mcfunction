...
execute as @e[tag=emetic_granade_init] at @s run summon arrow ~ ~ ~ {Tags:["emetic_granade"],life:800}
execute as @e[tag=emetic_granade] at @s run data modify entity @s Motion set from entity @e[type=snowball,sort=nearest,limit=1] Motion
