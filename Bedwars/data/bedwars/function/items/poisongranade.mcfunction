...
execute as @e[tag=poison_granade_init] at @s run summon arrow ~ ~ ~ {Tags:["poison_granade"],life:800}
execute as @e[tag=poison_granade] at @s run data modify entity @s Motion set from entity @e[type=snowball,sort=nearest,limit=1] Motion
...
execute as @e[tag=poison_granade,nbt={inGround:1b}] at @s run effect give @a[distance=..6,tag=!poison_imune] minecraft:poison 5 0 false
