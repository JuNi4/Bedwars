...
$function bedwars:shop_items/utilities/tick/popuptower_place {team:$(team), facing:north}
$function bedwars:shop_items/utilities/tick/popuptower_place {team:$(team), facing:east}
$function bedwars:shop_items/utilities/tick/popuptower_place {team:$(team), facing:south}
$function bedwars:shop_items/utilities/tick/popuptower_place {team:$(team), facing:west}