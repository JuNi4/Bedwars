...
$execute if score enable_popup_teleport data matches 1 as @e[tag=$(team)_popup_tower, tag=$(facing),scores={item_deathtime=1}] at @s run tp @a[distance=..2] ^ ^1 ^
# layer 2
...
$execute if score enable_popup_teleport data matches 1 as @e[tag=$(team)_popup_tower, tag=$(facing),scores={item_deathtime=4}] at @s positioned ^ ^1 ^ run tp @a[distance=..2] ^ ^1 ^
# layer 3
...
$execute if score enable_popup_teleport data matches 1 as @e[tag=$(team)_popup_tower, tag=$(facing),scores={item_deathtime=8}] at @s positioned ^ ^2 ^ run tp @a[distance=..2] ^ ^1 ^
# layer 4
...
$execute if score enable_popup_teleport data matches 1 as @e[tag=$(team)_popup_tower, tag=$(facing),scores={item_deathtime=12}] at @s positioned ^ ^3 ^ run tp @a[distance=..2] ^ ^1 ^
# layer 5
...
$execute if score enable_popup_teleport data matches 1 as @e[tag=$(team)_popup_tower, tag=$(facing),scores={item_deathtime=16}] at @s positioned ^ ^4 ^ run tp @a[distance=..2] ^ ^1 ^
# layer 6
...
$execute if score enable_popup_teleport data matches 1 as @e[tag=$(team)_popup_tower, tag=$(facing),scores={item_deathtime=20}] at @s positioned ^ ^5 ^ run tp @a[distance=..2] ^ ^1 ^
# layer 7
...
$execute if score enable_popup_teleport data matches 1 as @e[tag=$(team)_popup_tower, tag=$(facing),scores={item_deathtime=24}] at @s positioned ^ ^6 ^ run tp @a[distance=..2] ^ ^1 ^
