...
# iron
execute as @a[tag=iron_armor,tag=equipp] run item replace entity @s armor.legs with iron_leggings[unbreakable={},enchantments={"minecraft:blast_protection":3,"minecraft:binding_curse":1,"minecraft:vanishing_curse":1}]
execute as @a[tag=iron_armor,tag=equipp] run item replace entity @s armor.feet with iron_boots[unbreakable={},enchantments={"minecraft:blast_protection":3,"minecraft:binding_curse":1,"minecraft:vanishing_curse":1}]
...
# diamond
execute as @a[tag=diamond_armor,tag=equipp] run item replace entity @s armor.legs with diamond_leggings[unbreakable={},enchantments={"minecraft:blast_protection":3,"minecraft:binding_curse":1,"minecraft:vanishing_curse":1}]
execute as @a[tag=diamond_armor,tag=equipp] run item replace entity @s armor.feet with diamond_boots[unbreakable={},enchantments={"minecraft:blast_protection":3,"minecraft:binding_curse":1,"minecraft:vanishing_curse":1}]
