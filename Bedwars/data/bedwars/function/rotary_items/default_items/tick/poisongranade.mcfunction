...
execute as @e[tag=poison_granade_init] at @s run summon arrow ~ ~ ~ {Tags:["poison_granade"],life:800,item:{id:"minecraft:tipped_arrow",count:1,components:{"minecraft:potion_contents":{custom_effects:[{id:"minecraft:poison",amplifier:1,duration:2000,show_particles:1b,show_icon:0b}]}}}}
